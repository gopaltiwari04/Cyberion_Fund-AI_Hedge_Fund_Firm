...
export default function Home() {
  ...
  return <div className="app-shell">
    <aside className="sidebar" aria-label="Main navigation">
      <a className="brand" href="#overview"><span className="brand-mark">AI</span><span className="brand-name">AI Hedge Fund</span></a>
      <span className="nav-label">Workspace</span>
      <nav className="nav-list">
        <a className="nav-item active" href="#overview"><span className="nav-icon">◈</span><span>Overview</span></a>
        <a className="nav-item" href="#portfolio"><span className="nav-icon">◫</span><span>Portfolio</span></a>
        <a className="nav-item" href="#markets"><span className="nav-icon">⌁</span><span>Markets</span></a>
        <a className="nav-item" href="#research"><span className="nav-icon">⌕</span><span>Research</span></a>
        <a className="nav-item" href="#system"><span className="nav-icon">◌</span><span>System</span></a>
      </nav>
      <div className="sidebar-footer"><span className="live-dot" />Production environment<br />Read-only terminal</div>
    </aside>
    <main className="main-content" id="overview">
      <header className="topbar"><div className="breadcrumb">Workspace <span>/</span> <strong>Overview</strong></div><div className="topbar-right"><span className="status"><span className="live-dot" />{health ? "API operational" : errors.health ? "API unavailable" : "Checking API"}</span><span className="date-stamp">{today}</span></div></header>
